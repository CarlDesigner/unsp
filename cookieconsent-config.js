        ...
        translations: {
            es: {
                consentModal: {
                    ...
                    description: "Este sitio web utiliza Cookies para garantizar que tenga la mejor experiencia en nuestro sitio web, Algunas son esenciales para mantener el buen funcionamiento del sitio y nuestros servicios. Otras son opcionales y permiten personalizar tu experiencia y los anuncios,  además de generar estadísticas.",
